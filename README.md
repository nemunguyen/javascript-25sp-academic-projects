# javascript-25sp-academic-projects
This repository contains interactive client-side web applications engineered using HTML5, modern CSS3 layout paradigms, and dynamic JavaScript (ES6+). These applications focus on combining clean algorithmic logic with custom, responsive user interfaces that reflect the academic identity of Ritsumeikan Asia Pacific University (APU).

## Project Links: ** `https://nemunguyen.github.io/javascript-25sp-academic-projects/`
